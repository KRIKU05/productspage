      ...
      <div class="container">
        <div class="row v-center">
          <div class="header-item item-left">
            <div class="logo"> <a href="index.php"><img src="img/logo.png" alt="Shailendra Bhartti" /></a> </div>
          </div>
          <!-- menu start here -->
          ...
          <div class="header-item item-right">
            ...
            <div class="menu active"> <span class="btn-close">&times;</span>
              <ul class="links-container">
                ...
                <li><a href="work.php" class="">Works</a></li>
                <li><a href="blog.php" class="">Blogs</a></li>
